...
import {FacturaPreviewData} from './factura-preview.model';

@Component({
  selector: 'app-factura-preview',
  imports: [CommonModule, MatDialogModule, MatButtonModule, MatIconModule],
  templateUrl: './factura-preview.html',
  styleUrl: './factura-preview.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FacturaPreview implements AfterViewInit {
  private readonly quotePage = viewChild.required<ElementRef<HTMLElement>>('quotePage');
  private readonly multiPageStyleId = 'factura-multipage-page-style';
  private readonly snackbar = inject(SnackbarService);
  protected readonly data = inject<FacturaPreviewData>(MAT_DIALOG_DATA);
  protected readonly dialogRef = inject(MatDialogRef<FacturaPreview>);
