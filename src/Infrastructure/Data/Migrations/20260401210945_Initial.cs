        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "../../../assets/imgs/logo.png")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PermisosRol_Permisos_IdPermiso",
                        column: x => x.IdPermiso,
                        principalTable: "Permisos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PermisosRol_Roles_IdRol",
                        column: x => x.IdRol,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ImagenPerfilUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "../../../assets/imgs/user-placeholder.png"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermisosRol_IdPermiso",
                table: "PermisosRol",
                column: "IdPermiso");

            migrationBuilder.CreateIndex(
                name: "IX_PermisosRol_IdRol_IdPermiso",
                table: "PermisosRol",
